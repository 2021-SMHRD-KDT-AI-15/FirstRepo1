...
<body data-path-to-root="./" data-include-products="false"
				...
				<form action="ChargeService"
					...
					<div class="u-form-group u-form-name u-label-top">
						<label for="username-a30d"
							class="u-custom-font u-label u-text-custom-color-1 u-label-2">충전금액</label>
						<input type="text" placeholder="충전금액을 입력해주세요." id="username-a30d"
							name="charge_money"
					...
					<div class="u-align-left u-form-group u-form-submit u-label-top">
						...
						<a href="#"
							class="u-active-white u-border-none u-btn u-btn-submit u-button-style u-custom-color-1 u-custom-font u-hover-white u-radius u-text-active-custom-color-1 u-text-hover-custom-color-1 u-btn-1">충전하기</a>
					</div>
					<div id="chargeButton" style="width:50px; height:50px;"></div> <!-- 결제 api 띄우는 div -->
	...
	<script type="text/javascript" src="assets/js/Charge.js"></script>
