    ...
    <section class="u-clearfix u-section-1" id="sec-106b">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-form u-login-control u-form-1">
          <form action="ChargeService" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 0px;" method="post">
            
            
            <div class="u-form-group u-form-name u-label-top">
              <label for="username-a30d" class="u-custom-font u-label u-text-custom-color-1 u-label-2">충전금액</label>
              <input type="text" placeholder="충전금액을 입력해주세요." id="username-a30d" name="charge_money" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-input u-input-rectangle u-input-2" required="">
            </div>
            <div class="u-align-left u-form-group u-form-submit u-label-top">
              <input type="submit" value="submit" class="u-form-control-hidden">
              <a href="#" class="u-active-white u-border-none u-btn u-btn-submit u-button-style u-custom-color-1 u-custom-font u-hover-white u-radius u-text-active-custom-color-1 u-text-hover-custom-color-1 u-btn-1">충전하기</a>
            </div>
