...
<link rel="stylesheet" href="assets/css/PaymentHistory.css" media="screen">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header" id="sec-9269" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-gradient u-section-1" id="sec-2190">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <a href="PaymentHistoryService" class="u-btn u-button-style u-custom-font u-none u-text-active-custom-color-1 u-text-custom-color-1 u-text-hover-custom-color-1 u-btn-1" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">결제내역</a>
    ...
    <body style="text-align: center; padding-top : 30px">
        ...
        <table class="rwd-table">
            <tr>
                <th style="width:100px; color: white; font-size: 2em; text-align: center;"><strong>NO</strong></th>
                <th width="300px" style="color: white; font-size: 2em; text-align: center;"><strong>결제 일시</strong></th>
                <th width="300px" style="color: white; font-size: 2em; text-align: center;"><strong>결제 금액</strong></th>
                <th width="250px" style="color: white; font-size: 2em; text-align: center;"><strong>결제 내역</strong></th>
            </tr>
