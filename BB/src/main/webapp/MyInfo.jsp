		...
		<div class="u-clearfix u-sheet u-sheet-1" id="textStyle">
			...
			<table class="rwd-table">
				<tr style="background-color: coral;">
					<th style="text-align: center;" width="200" height="50"><b
						style="font-size: 20px">NO.</b></th>
				...
				<c:forEach var="review1" items="${getreview1}" begin="0" end="9999"
					...
					<tr>
						<td style="text-align: center;" width="200" height="50"><b>${status.count}</b></td>
						<td style="text-align: center;" width="1000" height="50"><b>${review1.review_ctnt}</b></td>
						<td style="text-align: center;" width="300" height="50"><b>${review1.nickname}</b></td>
					</tr>
				</c:forEach>
			</table>
		</div>
		...
		<div class="u-clearfix u-sheet u-sheet-1">
			...
			<table class="rwd-table">
				...
				<c:forEach var="review0" items="${getreview0}" begin="0" end="9999"
					...
					<tr>
						<td style="text-align: center;" width="200" height="50"><b>${status.count}</b></td>
						<td style="text-align: center;" width="1000" height="50"><b>${review0.review_ctnt}</b></td>
						<td style="text-align: center;" width="300" height="50"><b>${review0.nickname}</b></td>
					</tr>
				</c:forEach>
			</table>
		</div>
