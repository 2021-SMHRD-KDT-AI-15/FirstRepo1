...
<<<<<<< HEAD
         <a href="PaymentHistoryService"
            ...
            href="MyInfoService"
            class="u-btn u-button-style u-custom-font u-none u-text-active-custom-color-1 u-text-custom-color-1 u-text-hover-custom-color-1 u-btn-3"
            data-animation-name="" data-animation-duration="0"
...
>>>>>>> branch 'master' of https://github.com/2021-SMHRD-KDT-AI-15/BB.git
               ...
               <p class="u-custom-font u-text u-text-custom-color-3 u-text-1">${MyInfo.nickname}(${MyInfo.id})
                  ...
                  :&nbsp; &nbsp; &nbsp;<span style="font-size: 3rem;">${MyInfo.money}</span>&nbsp;
                  원
               </p>
            </div>
         </div>
         <div
            class="u-border-1 u-border-custom-color-1 u-container-style u-group u-group-2">
            <div class="u-container-layout u-container-layout-2">
               <p class="u-custom-font u-text u-text-custom-color-3 u-text-2">
                  &nbsp; &nbsp; &nbsp;내가 받은 좋아요😍<br> <br> <br>&nbsp;
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                  &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<br>&nbsp; &nbsp; &nbsp;
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span
                     style="font-size: 3rem;">${getlike}</span>&nbsp; &nbsp;개
               </p>
            </div>
         </div>
         <div
            class="u-border-1 u-border-custom-color-1 u-container-style u-group u-group-3">
            <div class="u-container-layout u-container-layout-3">
               <p class="u-custom-font u-text u-text-custom-color-3 u-text-3">
                  &nbsp; &nbsp; &nbsp;내가 받은 싫어요😢<br> <br> <br>&nbsp;
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                  &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<br>&nbsp; &nbsp; &nbsp;
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span
                     style="font-size: 3rem;"> ${getdislike}</span>&nbsp; &nbsp;개
               </p>
            </div>
         </div>
      </div>
   ...
   <section
      class="skrollable u-align-center u-clearfix u-custom-color-2 u-lightbox u-parallax u-shading u-section-2"
      id="sec-78e0">
      <div class="u-clearfix u-sheet u-sheet-1" id="textStyle">
         <p class="u-align-center u-custom-font u-text u-text-1">나에 대한 후기</p>
         <table>
            <tr bgcolor="coral">
               <th width="200" height="50"><b>NO.</b></th>
            ...
            <c:if test="${empty getreview1}">
               <tr>
                  <td colspan="3" align="center"><b color="black">해당 리뷰가
                        없습니다.</b></td>
               </tr>
            </c:if>
            <c:forEach var="review1" items="${getreview1}" begin="0" end="9999"
               ...
               <tr>
                  <td bgcolor="white" align="center" width="200" height="50"><b
                     color="black">${status.count}</b></td>
                  <td bgcolor="white" align="center" width="1000" height="50"><b
                     color="black">${review1.review_ctnt}</b></td>
                  <td bgcolor="white" align="center" width="300" height="50"><b
                     color="black">${review1.nickname}</b></td>
               </tr>
            </c:forEach>
         </table>
      </div>
   ...
   <section
      class="skrollable u-align-center u-clearfix u-custom-color-2 u-lightbox u-parallax u-shading u-section-3"
      id="sec-d201">
      <div class="u-clearfix u-sheet u-sheet-1">
         ...
         <table border="1">
            ...
            <c:if test="${empty getreview0}">
               <tr>
                  <td bgcolor="white" colspan="3" align="center" height="100"><b color="black">해당 리뷰가
                        없습니다.</b></td>
               </tr>
            </c:if>
            <c:forEach var="review0" items="${getreview0}" begin="0" end="9999"
               ...
               <tr>
                  <td bgcolor="white" align="center" width="200" height="50"><b
                     color="black">${status.count}</b></td>
                  <td bgcolor="white" align="center" width="1000" height="50"><b
                     color="black">${review0.review_ctnt}</b></td>
                  <td bgcolor="white" align="center" width="300" height="50"><b
                     color="black">${review0.nickname}</b></td>
               </tr>
            </c:forEach>
         </table>
      </div>
