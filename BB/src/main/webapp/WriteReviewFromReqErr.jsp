...
<body data-path-to-root="./" data-include-products="false"
	...
	<fieldset>
		...
		<div id="f1">
			회원님이 요청하신 심부름 <b>'${errandTitle}'</b> 에 지원한 <b>'${applyMemberNickname}'</b> 님에 대한 평가
		</div>
		<hr>
		<form action="WriteReviewService_reqLast" method="post">
			<input type="hidden" name="applyMemberNickname" value="${applyMemberNickname}">
			<!-- 지우면 안됨 -->
			<input type="hidden" name="applyMemberId" value="${applyMemberId}">
			<!-- 지우면 안됨 -->
