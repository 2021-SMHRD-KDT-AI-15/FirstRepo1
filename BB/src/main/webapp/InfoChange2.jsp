...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <title>InfoChange2</title>
    <link rel="stylesheet" href="assets/css/nicepage.css" media="screen">
<link rel="stylesheet" href="assets/css/InfoChange2.css" media="screen">
    ...
    <meta property="og:title" content="InfoChange2">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header" id="sec-9269" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-gradient u-section-1" id="sec-3cb2">
        ...
        <div class="custom-expanded u-align-center u-border-11 u-border-no-left u-border-no-right u-border-no-top u-border-white u-container-style u-custom-border u-group u-radius u-shape-round u-white u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <div class="u-form u-login-control u-form-1">
              <form action="InfoChangeService2" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 0px;" method="post">
                <div class="u-form-group u-form-name u-label-top">
                  <label for="username-a30d" class="u-custom-font u-label u-text-custom-color-1 u-label-1">변경할 닉네임</label>
                  <input type="text" placeholder="변경할 닉네임을 입력해주세요." id="username-a30d" name="nickname" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-input u-input-rectangle u-input-1" required="">
                </div>
                <div class="u-form-group u-label-top">
                  <label for="password-a30d" class="u-custom-font u-label u-text-custom-color-1 u-label-2">변경할 비밀번호</label>
                  <input type="text" placeholder="변경할 비밀번호를 입력해주세요" id="password-a30d" name="pw" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-input u-input-rectangle u-input-2" required="">
                </div>
                <div class="u-form-group u-label-top u-form-group-3">
                  <label for="text-fe1a" class="u-custom-font u-label u-text-custom-color-1 u-label-3">변경할 연락처</label>
                  <input type="text" placeholder="연락처를 입력해주세요" id="text-fe1a" name="phone" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-input u-input-rectangle u-input-3">
                </div>
                <div class="u-form-group u-label-top u-form-group-4">
                  <label for="text-eccf" class="u-custom-font u-label u-text-custom-color-1 u-label-4">변경할 주소 검색</label>
                  <input type="text" placeholder="주소를 입력해주세요" id="text-eccf" name="address" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-input u-input-rectangle u-input-4">
                </div>
