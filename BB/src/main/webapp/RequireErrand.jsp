...
<link rel="stylesheet" href="assets/css/RequireErrand.css" media="screen">
        ...
        <div class="custom-expanded u-align-center u-border-11 u-border-no-left u-border-no-right u-border-no-top u-border-white u-container-style u-custom-border u-group u-radius u-shape-round u-white u-group-1">
          <div class="u-container-layout u-valign-top u-container-layout-1">
            <div class="u-form u-login-control u-form-1">
              <form action="RequireErrandService" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 0px;" method="post">
                <div class="u-form-group u-form-name u-label-top">
                  <label for="username-a30d" class="u-custom-font u-label u-text-custom-color-1 u-label-1">심부름 제목 입력</label>
                  <input type="text" placeholder="제목을 입력해주세요." id="username-a30d" name="title" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-input u-input-rectangle u-input-1" required="">
                </div>
                <div class="u-form-group u-label-top">
                  <label for="password-a30d" class="u-custom-font u-label u-text-custom-color-1 u-label-2">요구 시작 시한</label>
                  <input type="date" placeholder="시작 시간 입력" id="password-a30d" name="req_date" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-input u-input-rectangle u-input-2" required="">
                </div>
                <div class="u-form-group u-label-top u-form-group-3">
                  <label for="text-1ce3" class="u-custom-font u-label u-text-custom-color-1 u-label-3">요구 마감 시한</label>
                  <input type="date" id="text-1ce3" name="want_date" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-input u-input-rectangle u-input-3" placeholder="희망 마감 시한 입력">
                </div>
                <div class="u-form-group u-label-top u-form-group-4">
                  <label for="text-413d" class="u-custom-font u-label u-text-custom-color-1 u-label-4">보상할 금액</label>
                  <input type="text" placeholder="금액을 입력해주세요" id="text-413d" name="price" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font  u-input u-input-rectangle u-input-4">
                </div>
                <div class="u-form-group u-label-top u-form-group-5">
                  <label for="text-2d79" class="u-custom-font u-label u-text-custom-color-1 u-label-5">요청 위치</label>
                  <input type="text" placeholder="주소 입력" id="text-2d79" name="req_location" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font  u-input u-input-rectangle u-input-5">
                </div>
                <div class="u-form-group u-label-top u-form-group-6">
                  <label for="text-76e2" class="u-custom-font u-label u-text-custom-color-1 u-label-6">요청 내용</label>
                  <input type="text" placeholder="내용 입력" id="text-76e2" name="content" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font  u-input u-input-rectangle u-input-6">
                </div>
                <div class="u-form-group u-form-partition-factor-2 u-form-select u-label-top u-form-group-7">
                  <label for="select-e794" class="u-custom-font u-label u-text-custom-color-1 u-label-7">행정구 선택</label>
                  <div class="u-form-select-wrapper">
                    <select id="select-e794" name="location_ctgr" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font  u-input u-input-rectangle u-input-7">
                ...
                <div class="u-form-group u-form-partition-factor-2 u-form-select u-label-top u-form-group-8">
                  <label for="select-f578" class="u-custom-font u-label u-text-custom-color-1 u-label-8">카테고리</label>
                  <div class="u-form-select-wrapper">
                    <select id="select-f578" name="errand_ctgr" class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-input u-input-rectangle u-input-8">
                ...
                <div class="u-form-group u-form-submit u-label-top">
                  ...
                  <a href="RequireErrandService" class="u-active-white u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-1 u-custom-font u-hover-white u-radius-50 u-text-active-custom-color-1 u-text-hover-custom-color-1 u-btn-1">요청하기</a>
                </div>
            ...
            <div class="u-container-style u-expanded-width u-group u-radius u-shape-round u-white u-group-2">
              <div class="u-container-layout u-valign-bottom u-container-layout-2">
                <a href="Main.jsp" class="u-active-white u-btn u-button-style u-custom-color-1 u-custom-font u-hover-white u-text-active-custom-color-1 u-text-hover-custom-color-1 u-btn-2" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">돌아가기</a>
              </div>
            </div>
          </div>
        </div>
