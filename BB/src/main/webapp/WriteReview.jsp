        ...
        <main>
            <fieldset id="fieldset">
                ...
                <section class="btn1">
                    ...
                    <div id="Nick_Name">"${nickname}" 님에 대한 평가</div>
                </section>
                <hr>
                <form action="WriteReviewService_reqLast" method="post">
                	<input type="hidden" name="applyMemberNickname" value="${nickname}"> <!-- 지우면 안됨 -->
                	<input type="hidden" name="applyMemberId" value="${subject_id}"> <!-- 지우면 안됨 -->
